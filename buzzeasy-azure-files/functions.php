<?php
	...
	*/
	...
	add_action( 'wp_enqueue_scripts', 'infinite_child_enqueue_styles' );

	function infinite_child_enqueue_styles() {

		$parent_style = 'style';

		$child_style  =  'mrb-insights';

    	wp_enqueue_style( $parent_style, get_template_directory_uri() . '/style.css' );

    	wp_enqueue_style( $child_style,
	        get_stylesheet_directory_uri() . '/css/mrb-styles/mrb-insights.css',
	        array( $parent_style ),
