...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "chunk-" + ({"0":"background-videos","1":"app-polyfills","2":"offcanvas-toggles","3":"inline-videos"}[chunkId]||chunkId) + "." + {"0":"0253b4a0dfd5524fbc61","1":"90bb2857beacf575729d","2":"82cb4cfd89f91ad57552","3":"b5c7dd02d6cf03f11243"}[chunkId] + ".js";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_pubsub_js__ = __webpack_require__(5);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    publish: function publish(topic, payload) {
        __WEBPACK_IMPORTED_MODULE_0_pubsub_js___default.a.publish(topic, payload);
    },
    subscribe: function subscribe(topic, fn) {
        __WEBPACK_IMPORTED_MODULE_0_pubsub_js___default.a.subscribe(topic, fn);
    }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_polyfills_promise__ = __webpack_require__(7);
...
if (!browserSupportsAllFeatures()) {
    __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 30)).then(function (polyfills) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_promise_polyfill__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_setasap__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_setasap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_setasap__);
...
Promise._immediateFn = __WEBPACK_IMPORTED_MODULE_1_setasap___default.a;
...
/* WEBPACK VAR INJECTION */(function(global, setImmediate, process) {var __WEBPACK_AMD_DEFINE_RESULT__;(function (thisVar, undefined) {
	'use strict';
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(2).setImmediate, __webpack_require__(3)))
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery_slim__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery_slim___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery_slim__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_third_party_lazysizes_bgset__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_third_party_lazysizes_bgset___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_third_party_lazysizes_bgset__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_third_party_lazysizes_bgset_polyfill__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_third_party_lazysizes_bgset_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_third_party_lazysizes_bgset_polyfill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_third_party_modernizr__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lazysizes__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lib_breakpoint_manager__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lib_eventbus__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_behaviours_webfonts__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_behaviours_svg_sprites__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_behaviours_responsive_img_bgs__ = __webpack_require__(25);
...
// import jQuery from 'jquery';
 ...
 // excludes ajax and effects modules if you need these please also update alias refs in webpack.config.js
...
if (__WEBPACK_IMPORTED_MODULE_5_lib_breakpoint_manager__["a" /* default */].matchSmaller('large')) {
    __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 27));
}

if (document.querySelectorAll('.js-inline-video').length) {
    __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 28));
}

if (document.querySelectorAll('.js-background-video').length) {
    __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 29));
}
...
/* global lazySizes, lazySizesConfig */
(function () {
    'use strict';
        ...
        for (i = 0; i < propsLength; i++) {
            ...
            if (mStyle.style[prop] !== undefined) {
                ...
                if (!skipValueTest && !is(value, 'undefined')) {
                    ...
                    // empty - to show ESLint that this catch is intentionally left empty
...
/* unused harmony default export */ var _unused_webpack_default_export = (modernizr);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sass_to_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sass_to_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_sass_to_js__);




// Grab all the breakpoints as JSON from the DOM
var breakpoints = __WEBPACK_IMPORTED_MODULE_0_sass_to_js___default()(document.querySelector('body'), {
    pseudoEl: ':after',
    cssProperty: 'content'
});

// Map to array retaining key,value relationship
breakpoints = $.map(breakpoints, function (value, key) {
    return {
        name: key,
        size: value
    };
...
var aBreakpoints = $.map(breakpoints, function (bp) {
    return bp.name;
});
...
/* WEBPACK VAR INJECTION */(function(__webpack_provided_window_dot_jQuery, jQuery) {var __WEBPACK_AMD_DEFINE_RESULT__;//! sass-to-js - v1.3.1 - 2017-07-16
//! author : Sergey Hospodarets
//! license : MIT
//! https://github.com/malyw/sass-to-js
!function(a){function b(a,b){return b=b||{},a?(b.cssProperty=b.cssProperty||"font-family",d(a,b)):(b.debug&&f([a," is not an HTML element"]),{})}function c(a){return b(this[0],a)}function d(b,c){var d,g={};if(d=c.pseudoEl?a.getComputedStyle(b,c.pseudoEl).getPropertyValue(c.cssProperty):a.getComputedStyle(b).getPropertyValue(c.cssProperty),null===d)return c.debug&&f(["CSS value for ",b," with params ",c," is empty"]),g;d=e(d);try{g=JSON.parse(d)}catch(a){c.debug&&f(["Cannot parse JSON from ",b," with params ",c])}return g}function e(a){return a=a.replace(/^['"]+|\s+|\\|(;\s?})+|['"]$/g,"")}function f(b){a.console&&console.error&&console.error(b)}var g=!1;"function"==typeof __webpack_provided_window_dot_jQuery&&(jQuery.fn.sassToJs=c,jQuery.fn.sassToJsOriginal=b,g=!0),"function"==typeof a.angular&&(angular.element.prototype.sassToJs=c,angular.element.prototype.sassToJsOriginal=b,g=!0),"function"=="function"&&__webpack_require__(18)&&(!(__WEBPACK_AMD_DEFINE_RESULT__ = (function(){return b}).call(exports, __webpack_require__, exports, module),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)),g=!0),"undefined"!=typeof module&&module.exports&&(module.exports=b,g=!0),g||(a.sassToJs=b)}(window);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lib_webfonts__ = __webpack_require__(21);




Object(__WEBPACK_IMPORTED_MODULE_0_lib_webfonts__["a" /* default */])();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_fontfaceobserver__ = __webpack_require__(22);
...
function webfonts() {
    ...
    //    LatoBold    = Lato 700
    var webFont = new __WEBPACK_IMPORTED_MODULE_0_fontfaceobserver___default.a('ExampleFont');

    // 3. Race the Font load against the timeout
    Promise.race([timer(timeout), // if the fonts aint loaded fast enough then kick off big time!
    webFont.load()]).then(function () {
...
/* harmony default export */ __webpack_exports__["a"] = (webfonts);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lib_svg_spritemap_loader__ = __webpack_require__(24);
/**
 * SVG SPRITEMAP
...
var spriteSheet = LOCALISED_VARS.stylesheet_directory_uri + '/assets/svg/sprites/output/spritesheet.svg';

new __WEBPACK_IMPORTED_MODULE_0_lib_svg_spritemap_loader__["a" /* default */](spriteSheet);
...
var SVGSpriteLoader = function () {
    function SVGSpriteLoader(url) {
        _classCallCheck(this, SVGSpriteLoader);

        this.url = url;
        this.loadSpriteSheet();
    }

    _createClass(SVGSpriteLoader, [{
        key: 'loadSpriteSheet',
        ...
        key: '_insertSpriteSheet',
        value: function _insertSpriteSheet(sheet) {
    ...
    return SVGSpriteLoader;
}();

// Export


/* harmony default export */ __webpack_exports__["a"] = (SVGSpriteLoader);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lib_rimg_bg__ = __webpack_require__(26);
...
$(window).on('load', function () {
    $('.js-rimgbg').each(function (index, el) {
        new __WEBPACK_IMPORTED_MODULE_0_lib_rimg_bg__["a" /* default */]($(el));
    });
});
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
...
var RImgBg = function () {
    ...
    _createClass(RImgBg, [{
        ...
        value: function init($this) {
            ...
            var src = targetImg[0].currentSrc || targetImg[0].src;
        ...
        key: 'setBgImg',
        value: function setBgImg(el, src) {
...
/* harmony default export */ __webpack_exports__["a"] = (RImgBg);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
