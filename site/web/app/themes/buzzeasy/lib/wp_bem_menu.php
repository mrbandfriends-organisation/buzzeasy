...
namespace Roots\Sage\DropDownWalker;
...
class walker_texas_ranger extends \Walker_Nav_Menu {
    ...
    function __construct($css_class_prefix) {
        ...
        $this->item_css_class_suffixes = array(
            'item'                      => 'menu-item menu-primary__item',
            'parent_item'               => 'menu-primary__item--parent',
            'active_item'               => 'menu-primary__item--active',
            'parent_of_active_item'     => 'menu-primary__item--parent--active',
            'ancestor_of_active_item'   => 'menu-primary__item--ancestor--active',
            'sub_menu'                  => 'menu-primary__sub-menu ',
            'sub_menu_item'             => 'menu-item menu-primary__sub-menu__item',
    ...
    function start_lvl(&$output, $depth = 1, $args=array()) {
        ...
        $output .= "\n" . $indent . '<div class="menu-primary__dropdown"><ul class="'. $class_names .'">' ."\n";
    }
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $item_classes =  array(
            ...
            'depth_class'           => $depth >=1 ? $prefix . $suffix['sub_menu_item'] . ' ' . $prefix . $suffix['sub_menu'] . '--' . $depth . '__item' : '',
             'item_id_class'         => $prefix . 'menu-primary__item--'. $item->object_id,
            'user_class'            => $item->classes[0] !== '' ? $prefix . 'menu-primary__item--'. $item->classes[0] : ''
        );
...
function bem_menu($location = "main_menu", $css_class_prefix = 'main-menu', $css_class_modifiers = null){
    ...
    $args = array(
        ...
        'container'         => false,
        'items_wrap'        => '<ul id="menu-primary-menu" class="' . $css_class_prefix . ' ' . $modifiers . '">%3$s</ul>',
