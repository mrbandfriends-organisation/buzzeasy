...
if ( class_exists( 'GFCommon' ) ) {
    ...
    /**
     *  GFORM DISABLE VIEW COUNTER
     *
     *  This filter is used to prevent all forms view counter being incremented.
     *  The views column will remain displayed on the Forms page.
    */
    add_filter( 'gform_disable_view_counter', __NAMESPACE__ . '\\__return_true' );
